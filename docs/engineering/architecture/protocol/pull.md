...
- **Page end.** The server returns at most 50 changes. With fewer than 50, `toCursor` is the channel head; with exactly 50, it is the last change's cursor. Clients treat fewer than 50 as "channel drained".

Code: [core/protocol.rs](../../../../crates/core/src/protocol.rs) (`PullRequest`, `PullPage`, `RecordChange`).
