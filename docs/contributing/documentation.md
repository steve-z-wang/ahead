...
- Use consistent concept names: Model, Record, Identity, Mutation, Handler, Loader, Channel, Publish, Client, Persistence, Push/Pull, Cursor and Checkpoint.
