CREATE TABLE IF NOT EXISTS lfs_client (
...
CREATE TABLE IF NOT EXISTS lfs_channel (
 channel text PRIMARY KEY,
 head bigint NOT NULL CHECK(head >= 0 AND head <= 9007199254740991)
);
CREATE TABLE IF NOT EXISTS lfs_invalidation (
 channel text NOT NULL REFERENCES lfs_channel(channel),
 model text NOT NULL,
