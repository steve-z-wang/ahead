//! Transaction-bridge probe: proves that an asynchronous host callback runs
//! inside the application's transaction and that a Rust failure after a host
//! write rolls both back. Test-only; see `integration/bindings/node`.
