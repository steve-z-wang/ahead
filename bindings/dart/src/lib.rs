...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn lfs_call(input: *const c_char) -> *mut c_char {
...
/// # Safety
/// output must be a pointer returned by lfs_call, freed exactly once.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn lfs_free(output: *mut c_char) {
    if !output.is_null() {
