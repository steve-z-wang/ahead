...
This internal Flutter harness tests the local-first-state Dart facade against process-linked Rust and SQLite. Run it through `bash integration/platform/run_ios_simulator_smoke.sh` from the repository root as documented in the [platform README](../README.md).
