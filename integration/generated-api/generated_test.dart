...
void main(){
 ...
 test('generated mutations and query use real native client',()async{
  ...
  final client=await GeneratedClient.open(path:'${temp.path}/state.sqlite',libraryPath:Platform.environment['SAVOIA_DART_LIBRARY'] ?? '../../target/debug/libsavoia_dart.dylib');
  try{
