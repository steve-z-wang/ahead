...
(cd "$root" && cargo run -p otter-compiler -- compile examples/rust-round-trip/models examples/rust-round-trip/generated --backend-runtime ../../../packages/server/index.mts) --client-runtime ../../../packages/client-js/index.mts
...
node "$root/examples/rust-round-trip/server.mts"
